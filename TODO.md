...
- [x] Dokumentacja uruchomienia (README): host vs kontenery, porty (8501 dashboard, 8081 Flink, 9092 Kafka, 27017 Mongo), co startuje w Dockerze, jak zgłosić job, jak podejrzeć/wyczyścić Mongo.
